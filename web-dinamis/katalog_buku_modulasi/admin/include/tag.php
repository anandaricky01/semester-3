                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td align="center">
                        ...
                        <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?php echo $tag; ?>?'))window.location.href='tag&aksi=hapus&data=<?php echo $id_tag;?>&notif=hapusberhasil'"  
