...
<section class="content-header">
    ...
    <section class="content">
            <div class="card">
              ...
              <div class="card-body">
              <div class="col-md-12">
                  <form method="post" action="kategori-blog">
                    <div class="row">
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td align="center">
                        <a href="edit-kategori-blog&data=<?php echo $id_kategori_blog;?>" class="btn btn-xs btn-info"><i class="fas fa-edit"></i> Edit</a>
                        <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?php echo $kategori_blog; ?>?'))window.location.href = 'kategori-blog&aksi=hapus&data=<?php echo $id_kategori_blog;?>&notif=hapusberhasil'" class="btn btn-xs btn-warning"><i class="fas fa-trash"></i> Hapus</a>
                      </td>
                    </tr>
                    <?php $no++;}?>
                  </tbody>
