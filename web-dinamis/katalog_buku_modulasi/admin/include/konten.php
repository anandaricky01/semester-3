                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td align="center">
                        <a href="edit-konten&data=<?php echo $id_konten;?>" class="btn btn-xs btn-info"><i class="fas fa-edit"></i></a>
              ...
              <div class="card-footer clearfix">
                ...
                if($jum_halaman==0){
                   ...
                   if($halaman!=1){
                     ...
                     href='konten&halaman=1'>First</a></li>";
                     echo "<li class='page-item'><a class='page-link' 
                     href='konten&halaman=$sebelum'>«</a></li>";
                  }
                  for($i=1; $i<=$jum_halaman; $i++){
                      if ($i > $halaman - 5 and $i < $halaman + 5 ) {
                         if($i!=$halaman){
                             echo "<li class='page-item'><a class='page-link' 
                            href='konten&halaman=$i'>$i</a></li>";
                         }else{
                   ...
                   if($halaman!=$jum_halaman){
                        echo "<li class='page-item'><a class='page-link' 
                        href='konten&halaman=$setelah'>»</a></li>";
                        echo "<li class='page-item'><a class='page-link' 
                        href='konten&halaman=$jum_halaman'>Last</a></li>";
                   }
